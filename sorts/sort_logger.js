import { createOutputEl, getSortedArrDOM } from "../minigames/minigame_utils.js";
...
export function showSortedArr(arr) {
...
export function calculateTheoreticalComparisons(n, complexity) {
    switch (complexity) {
...
export function logTheoreticalComparisons(n, complexities) {
